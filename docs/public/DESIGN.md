...
> 版本：v0.9.4｜设计状态：✅ 已落地 / ⚠️ 已写待补完 / 🔲 设计草案（待实现）
> 审阅视角：高级工程师 / 高级架构师
...
> **v0.9.4（2026-09-23，已发布）**：修复运行时上下文断层（异步修复任务 trace_data 补位）、MCP stacktrace 工具按 request_id 真实栈帧还原、追踪摘要提取支持 trace_data、Dashboard 事件总线线程安全加固，以及收敛废弃未文档化端点 POST /debug（返回 410）。

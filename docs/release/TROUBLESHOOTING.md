...
**验证 / Verify**: 服务正常启动，日志输出 `服务启动 | ai-debug-mcp v0.3.0`
...
3. 查阅 [功能交付矩阵 / Delivery Matrix](../internal/DELIVERY_MATRIX.md) 了解功能详情
4. 查阅 [稳定性报告 / Stability Report](../internal/STABILITY_REPORT.md) 了解已知问题

...
def get_error_store() -> ErrorStorage:
    ...
    if _error_store is None:
        ...
        if settings.storage_backend == "postgresql":
            try:
                if settings.pg_async_enabled:
                    from app.mcp.core.storage.async_pg_store import AsyncPGErrorStore
                    ...
                    from app.mcp.core.storage.pg_store import PGErrorStore
...
def get_spec_store() -> SpecStorage:
    ...
    if _spec_store is None:
        ...
        if settings.storage_backend == "postgresql":
            try:
                if settings.pg_async_enabled:
                    from app.mcp.core.storage.async_pg_store import AsyncPGSpecStore
                    ...
                    from app.mcp.core.storage.pg_store import PGSpecStore

...
**Lujo-MCP v0.5.1**（npm `@lujoai/lujo-mcp@0.5.1`，开箱即用）

> 版本统一：app / npm / README / CHANGELOG / MCP serverInfo / git tag 均为 `0.5.1`。
